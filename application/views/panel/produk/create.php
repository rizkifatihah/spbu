        ...
        <div class="card">
          ...
          <div class="card-content collpase show">
            <div class="card-body">
              ...
              <form class="form" action="<?php echo base_url('product/create/do_create'); ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      <div class="form-group col-12 mb-2">
                        ...
                        <input class="form-control border-primary" type="number" step="0.01" placeholder="Masukkan Harga Produk" name="harga_produk" id='harga_produk' required>
                      </div>
                    </div>
                  </div>
